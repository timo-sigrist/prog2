...
set CLASSPATH=%APP_HOME%\lib\server-2022.1.jar;%APP_HOME%\lib\base-2022.1.jar


@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" ch.zhaw.pm2.multichat.server.ServerManager %*
